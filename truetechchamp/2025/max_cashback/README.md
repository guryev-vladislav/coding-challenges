...
Выведите одно целое число — максимальный кешбэк в рублях, который мог получить клиент в начале сентября.

## Файлы

- Решение: [max_cashback.go](max_cashback.go)
- Тесты: [max_cashback_test.go](max_cashback_test.go)
